...
- **Taking a request from the owner:** before acting, say it back in one line (what is asked, what is not) and name anything you are adding to it. Quote the owner's words at the start of the log entry. Then carry on; do not wait unless your reading is in doubt.
