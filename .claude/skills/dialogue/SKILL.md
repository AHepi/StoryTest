...
flowchart TD
  ...
  B -.->|"first full run"| T["owner-theory passages on talk"]
  D -.->|"first full run"| T
...
4. Would fear, shame, manners or a tie keep this underneath, and does keeping it still cost less than telling it? If not, is saying it a move that costs the speaker something with this listener, or a report of what the audience already knows? Let them say it only when it is a costly move.
